...
function SignUp() {
    ...
    return (
        <div
            className={
                "min-h-screen bg-gradient-to-r from-blue-200 to-purple-200 flex items-center justify-center p-6 mobile:p-0"
            }
        >
            <div
                className={
                    "min-w-[320px] dark:bg-[#333] w-full p-[20px] rounded-lg shadow-lg max-w-[450px] min-h-[600px] mobile:h-screen bg-white mobile:rounded-none"
                }
            >
